  ...
  // document.getElementById("forme").submit();
              ...
              <div class="col-md-3">
                <div class="list-group">
                  ...
                  <?php
                            ...
                            $query = "select distinct(`loginid`) from `prebuilt_tbl` where status =1  order by `loginid` desc";
                            ...
                            <div class="list-group-item checkbox">
                                <label><input type="checkbox" class="common_selector loginid" value="<?php echo $row['loginid']; ?>"  > <?php echo $row['loginid']; ?> </label>
                            </div>
                            <?php
                            }
    ...
    $(document).ready(function(){
        ...
        function filter_data()
        {
            ...
            var loginid = get_filter('loginid');

            $.ajax({
                url:"fetch_data_prebulit.php",
                method:"POST",
                data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price,loginid:loginid, ram_size:ram_size,ram_type:ram_type, category:category},
